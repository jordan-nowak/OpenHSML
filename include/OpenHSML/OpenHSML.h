...
class OpenHSML {
  public :
      ...
      void stereovision_hybrid(cv::Mat fundamental_matrix, Eigen::MatrixXd projection_matrix, struct Input_Points input_points, struct Input_Images input_img, struct Output_Points& output_points, cv::Mat& output_img, bool arg_display, bool arg_save, std::string calibration_namefile, std::string nameFile_toSave="/tmp");
};
